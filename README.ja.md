...
> ふたりの間にある細かいことを、相手が感じ取れるプレゼントに変える。
...
Claude スキルです。「AI ギフトアドバイザー」ではありません。**あなたの話を聞いて、ふたりの間にある細かいエピソードを、相手が「あなたは本当に私のことをわかってる」と感じるプレゼント＋メッセージ＋渡し方に変えます。**

少し話すだけで十分です。ノートがあれば使えますが、なくても構いません。

**コアの信念：プレゼントの目的は、ふたりの間の信頼を深めること。**

## 普通の AI と礼説の違いは？

差はプレゼントの値段ではなく、具体的なエピソードに命中しているかどうかです。

| 状況 | 普通の AI が言うこと | 礼説が言うこと |
|---|---|---|
| 妻の誕生日、引っ越しで疲れている | 「花やキャンドルを送って、愛情を伝えましょう。」 | あなたが「友達と集まりたいと言っていた」という話をもとに：その願いをプレゼントに変え、そのまま使える言葉を添える |
| 3日間の冷戦、謝りたい | 「バラを送って、謝罪の手紙を書きましょう。」 | まず：プレゼントは謝罪の代わりにはなりません。そのうえで、控えめで低調な3案——お金で感情問題を解決させない |
| 彼女がプレッシャーで大変、邪魔せずサポートしたい | 「アロマや入浴剤と『頑張って』カードを送りましょう。」 | あなたが「座ると胃が痛い」と言っていたことをもとに：今週の夕食を全部作ることを提案——プレゼントは行動であってモノではない |
